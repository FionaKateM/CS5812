...
movies_df <- movies_df %>% 
  rename(
     ...
     Reviews_by_Crtiics = Reviews.by.Crtiics,
...
for(genre in unique_genres) {
  movies_df[genre] <- sapply(movies_df$Genres, function(g) as.integer(genre %in% g))
  cat(paste(genre," = as.factor(",genre,"),",sep = ""))
  cat("\n")
}
...
```{r}
write_csv(movies_df,file = "movies_clean.csv")
```
